...
impl Palette {
    ...
    pub fn light() -> Self {
        Self {
            ...
            teal: oklch(0.55, 0.085, 195.0),
            teal_soft: oklcha(0.55, 0.085, 195.0, 0.14),
            teal_deep: oklch(0.51, 0.085, 195.0),
            coral: oklch(0.63, 0.115, 30.0),
            coral_soft: oklcha(0.63, 0.115, 30.0, 0.14),
            coral_deep: oklch(0.59, 0.115, 30.0),
            amber: oklch(0.67, 0.130, 65.0),
            amber_soft: oklcha(0.67, 0.130, 65.0, 0.14),
            amber_deep: oklch(0.63, 0.130, 65.0),
            violet: oklch(0.55, 0.085, 295.0),
            violet_soft: oklcha(0.55, 0.085, 295.0, 0.14),
            violet_deep: oklch(0.51, 0.085, 295.0),
            green: oklch(0.53, 0.120, 145.0),
            green_soft: oklcha(0.53, 0.120, 145.0, 0.14),
            green_deep: oklch(0.49, 0.120, 145.0),
            blue: oklch(0.51, 0.090, 260.0),
            blue_soft: oklcha(0.51, 0.090, 260.0, 0.14),
            blue_deep: oklch(0.47, 0.090, 260.0),
